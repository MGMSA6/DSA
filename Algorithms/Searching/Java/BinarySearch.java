...
public class BinarySearch {
    ...
    public static void main(String[] args) {
        ...
        position = iterativeSearch(arr, 0, len - 1);
     ...
     * @return position
     */
    public static int recursiveSearch(int[] arr, int left, int right) {
     ...
     * @return
     */
    public static int iterativeSearch(int[] arr, int left, int right) {
